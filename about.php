...
?>
	...
	<h3>Paul Bausch</h3>
		...
		-->
			...
			<div class="socmeed">
				<a href="//www.flickr.com/photos/pb" title="Flickr" rel="me"><svg id="flickricon" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414"><defs><linearGradient id="fGradient"><stop offset="0%" stop-color="#0B64DF" stop-opacity="1" /><stop offset="50%" stop-color="#0B64DF" stop-opacity="1" /><stop offset="50%" stop-color="#FF2D80" /><stop offset="100%" stop-color="#FF2D80" /></linearGradient></defs><path d="M0 8c0 2.05 1.662 3.71 3.71 3.71 2.05 0 3.713-1.66 3.713-3.71S5.76 4.29 3.71 4.29C1.663 4.29 0 5.95 0 8zm8.577 0c0 2.05 1.662 3.71 3.712 3.71C14.33 11.71 16 10.05 16 8s-1.662-3.71-3.71-3.71c-2.05 0-3.713 1.66-3.713 3.71z"/></svg></a>
			</div>
			<div class="socmeed">
