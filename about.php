...
?>
	...
	<div style="text-align:center;">
		<img src="https://d1x6es5xzge33k.cloudfront.net/pb-deck-avatar-backup.jpg" width="140" height="140" alt="Paul Bausch" style="display:block;margin:auto;margin-bottom:15px;border-radius: 50%;" loading="lazy" />
	</div>
	<h2 class="title">About Paul Bausch</h2>
		...
		<br><br>
		<div class="project">
		<div class="project-icon"><img alt="Oregon State Logo" src="https://d1x6es5xzge33k.cloudfront.net/about-osu-logo.png" width="50" height="50" style="margin-top:-5px;" /></div>
		...
		<div class="project">
		<div class="project-icon"><img alt="MetaFilter Logo" src="https://d1x6es5xzge33k.cloudfront.net/about-mefi-logo.png" width="50" height="50" class="by-the-power-of" /></div>
		<div class="project-text">
		...
		<div class="project">
		<div class="project-icon"><img alt="Fuelly Logo" src="https://d1x6es5xzge33k.cloudfront.net/about-fuelly-logo.png" width="50" height="50" class="by-the-power-of" /></div>
		<div class="project-text">
		...
		<div class="project">
		<div class="project-icon"><img alt="ORblogs Logo" src="https://d1x6es5xzge33k.cloudfront.net/about-orblogs-logo.png" width="50" height="50" class="by-the-power-of" /></div>
		<div class="project-text">
		From 2003-2008 I developed and ran ORblogs.com, an Oregon weblog directory.&lrm;
		</div>
		</div>
		<div class="project">
		<div class="project-icon"><img alt="O'Reilly Media Logo" src="https://d1x6es5xzge33k.cloudfront.net/about-ora-logo.png" width="50" height="50" class="by-the-power-of" /></div>
		<div class="project-text">
		...
		<div class="project">
		<div class="project-icon"><img alt="Blogger Logo" src="https://d1x6es5xzge33k.cloudfront.net/about-blogger-logo.png" width="50" height="50" class="by-the-power-of" /></div>
		<div class="project-text">
		...
		<div id="socialgrid">
			<div class="socmeed">
				<a href="https://www.flickr.com/photos/pb" title="Flickr" rel="me" aria-label="pb on Flickr"><svg id="flickricon" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414"><defs><linearGradient id="fGradient"><stop class="flickrblue" offset="0%" stop-color="#000" stop-opacity="1" /><stop class="flickrblue" offset="50%" stop-color="#000" stop-opacity="1" /><stop class="flickrpink" offset="50%" stop-color="#000" /><stop class="flickrpink" offset="100%" stop-color="#000" /></linearGradient></defs><path d="M0 8c0 2.05 1.662 3.71 3.71 3.71 2.05 0 3.713-1.66 3.713-3.71S5.76 4.29 3.71 4.29C1.663 4.29 0 5.95 0 8zm8.577 0c0 2.05 1.662 3.71 3.712 3.71C14.33 11.71 16 10.05 16 8s-1.662-3.71-3.71-3.71c-2.05 0-3.713 1.66-3.713 3.71z"/></svg></a>
				<div class="soccaption">Flickr</div>
			</div>
			<div class="socmeed">
				<a href="https://github.com/pbausch/" title="GitHub" rel="me" aria-label="pbausch on GitHub"><svg id="githubicon" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414"><path d="M8 0C3.58 0 0 3.582 0 8c0 3.535 2.292 6.533 5.47 7.59.4.075.547-.172.547-.385 0-.19-.007-.693-.01-1.36-2.226.483-2.695-1.073-2.695-1.073-.364-.924-.89-1.17-.89-1.17-.725-.496.056-.486.056-.486.803.056 1.225.824 1.225.824.714 1.223 1.873.87 2.33.665.072-.517.278-.87.507-1.07-1.777-.2-3.644-.888-3.644-3.953 0-.873.31-1.587.823-2.147-.09-.202-.36-1.015.07-2.117 0 0 .67-.215 2.2.82.64-.178 1.32-.266 2-.27.68.004 1.36.092 2 .27 1.52-1.035 2.19-.82 2.19-.82.43 1.102.16 1.915.08 2.117.51.56.82 1.274.82 2.147 0 3.073-1.87 3.75-3.65 3.947.28.24.54.73.54 1.48 0 1.07-.01 1.93-.01 2.19 0 .21.14.46.55.38C13.71 14.53 16 11.53 16 8c0-4.418-3.582-8-8-8"/></svg></a>
				<div class="soccaption">GitHub</div>
			</div>
			<div class="socmeed">
				<a href="https://www.linkedin.com/in/paulbausch" title="LinkedIn" rel="me" aria-label="paulbausch on LinkedIn"><svg id="linkedinicon" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414"><path d="M13.632 13.635h-2.37V9.922c0-.886-.018-2.025-1.234-2.025-1.235 0-1.424.964-1.424 1.96v3.778h-2.37V6H8.51v1.04h.03c.318-.6 1.092-1.233 2.247-1.233 2.4 0 2.845 1.58 2.845 3.637v4.188zM3.558 4.955c-.762 0-1.376-.617-1.376-1.377 0-.758.614-1.375 1.376-1.375.76 0 1.376.617 1.376 1.375 0 .76-.617 1.377-1.376 1.377zm1.188 8.68H2.37V6h2.376v7.635zM14.816 0H1.18C.528 0 0 .516 0 1.153v13.694C0 15.484.528 16 1.18 16h13.635c.652 0 1.185-.516 1.185-1.153V1.153C16 .516 15.467 0 14.815 0z" fill-rule="nonzero"/></svg></a>
				<div class="soccaption">LinkedIn</div>
			</div>
			<div class="socmeed">
				<a href="https://mastodon.cloud/@pb" title="Mastodon" rel="me" aria-label="pb on Mastodon"><svg xmlns="http://www.w3.org/2000/svg" width="61.076954mm" height="65.47831mm" viewBox="0 0 216.4144 232.00976">
