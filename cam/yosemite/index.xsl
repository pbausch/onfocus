...
<html>
<head>
	<title>onfocus.com : yosemite - may 2001</title>
		...
		<td align="center" valign="center">
			<table width="300" cellpadding="5" cellspacing="0" border="0">
				...
				<tr>
					<td align="left">
						<font size="2">
							<xsl:eval>GetBack(me,"&lt;img border=0 src=hike_back.gif&gt;")</xsl:eval>
						</font>
					</td>
					<td align="right">
						<font size="2">
							<xsl:eval>GetNext(me,"&lt;img border=0 src=hike_next.gif&gt;")</xsl:eval>
						</font>
					</td>
				</tr>
