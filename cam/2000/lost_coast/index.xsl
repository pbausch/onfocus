	...
	<tr>
		<td align="center" valign="center">
			<table width="300" cellpadding="5" cellspacing="0" border="0">
				<tr>
					<td align="left">
						<font face="arial"><b>the lost coast</b></font>
					</td>
					<td align="right">
						<font face="arial" size="2"><b>#<xsl:value-of select="picture/@id"/> of <xsl:value-of select="picture/@total"/></b></font>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td></td>
					<td align="right">
						<font face="arial" size="1">check out my other <a href="http://www.onfocus.com/cam/lost_coast/">lost coast trip</a><br/>copyright2k by pb | <a href="http://www.onfocus.com">refocus</a></font>
					</td>
				</tr>
			</table>
		</td>
