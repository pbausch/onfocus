...
<xsl:script xmlns:xsl="http://www.w3.org/TR/WD-xsl" language="VBScript"><![CDATA[
	...
	Function GetNext(node,wrap)
		...
		Else
			GetNext = "<div style=""width:67px"">&nbsp;&nbsp</div>"
		End If
		Set x = Nothing
	End Function
	...
	Function GetBack(node,wrap)
		...
		Else
			GetBack = "<div style=""width:67px"">&nbsp;&nbsp</div>"
		End If
		Set x = Nothing
	End Function
...
<html>
<head>
	<title>onfocus.com : radio dials</title>
...
<body bgcolor="#FFFFFF" topmargin="0" leftmargin="0" text="#999999" alink="gray" link="#333333" vlink="#666666">
	...
	<tr>
		<td align="center" valign="center">
			<table width="300" cellpadding="0" cellspacing="5" border="0">
				...
				<tr>
					<td colspan="2" align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td align="left" valign="top"><xsl:eval>GetBack(me,"&lt;img border=0 src=back.gif&gt;")</xsl:eval></td><td align="center"><div class="caption"><nobr><font color="#666666" face="arial" size="1">&#8226; <xsl:value-of select="picture/@id"/> of <xsl:value-of select="picture/@total"/> &#8226;</font></nobr><xsl:apply-templates select="picture/meta/caption"/></div></td><td align="right" valign="top"><xsl:eval>GetNext(me,"&lt;img border=0 src=next.gif&gt;")</xsl:eval></td></tr></table></td>
				</tr>
				...
				<tr>
					<td colspan="2" align="center">
						<br/><br/>
						<img src="copyright.gif" alt="copyright 1998-2003 pb" width="141" height="14"/><a href="http://www.onfocus.com/"><img src="refocus.gif" border="0" alt="refocus" width="94" height="14"/></a>
					</td>
				</tr>
			</table>
		</td>
