...
<html>
<head>
	<title>Anya and Preston Wedding Photos</title>
...
<body bgcolor="#ffffff" topmargin="0" leftmargin="0" text="#333333" alink="#cccccc" link="#666666" vlink="#999999">
	...
	<tr>
		<td align="center" valign="center">
			<table width="300" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td align="left"><img src="anya-preston.gif" alt="Anya and Pretson" border="0"/><xsl:if test="picture/meta/sound"></xsl:if></td>
				...
				<tr>
					<td  colspan="2" align="center" valign="center" bgcolor="#333333" style="border:solid black 2px;"><xsl:apply-templates select="picture/file"/></td>
				</tr>
				<tr>
					<td colspan="2" align="center"><table width="100%"><tr><td align="left" valign="top"><font size="2"><xsl:eval>GetBack(me,"&amp;laquo; back")</xsl:eval></font></td><td align="center"><div class="caption"><xsl:apply-templates select="picture/meta/caption"/></div></td><td align="right" valign="top"><font size="2"><xsl:eval>GetNext(me,"next &amp;raquo;")</xsl:eval></font></td></tr></table></td>
				</tr>
