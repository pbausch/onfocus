	...
	<tr>
		<td align="center" valign="center">
			<table width="300" cellpadding="5" cellspacing="0" border="0">
				<tr>
					<td align="left">
						<font face="arial"><b>tv</b></font>
					</td>
					<td align="right">
						<nobr><font face="arial" size="2"><b>chan. <xsl:value-of select="picture/@id"/> of <xsl:value-of select="picture/@total"/></b></font></nobr>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td align="left">
						<font size="2">
							<xsl:eval>GetBack(me,"down")</xsl:eval>
						</font>
					</td>
					<td align="right">
						<font size="2">
							<xsl:eval>GetNext(me,"up")</xsl:eval>
						</font>
					</td>
				</tr>
