...
function checkForm(f) {
	...
	<title>onfocus.com | Lisa and Jason</title>
</head>

<body bgcolor="#FFFFFF" text="#999999" alink="#333333" link="#333333" vlink="#333333">
<div id="container"><xsl:attribute name="style">width:<xsl:value-of select="/picture/@width"/>px;</xsl:attribute>
			<table width="300" cellpadding="0" cellspacing="5" border="0">
				<tr>
					<td class="title">Lisa and Jason</td>
...
<div id="copynav">copyright 2005 <a href="https://pbcoding.com/onfocus/contact.asp">Paul Bausch</a>  +  <a href="http://www.onfocus.com">refocus</a></div>
...
<xsl:template match="picture/file">
		<img>
			...
			<xsl:attribute name="style">border:solid 1px #ccc;background-color:#aaa;</xsl:attribute>
		</img>
</xsl:template>
