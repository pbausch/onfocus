...
function checkForm(f) {
	...
	<title>onfocus.com | Mexico Coast</title>
</head>
...
<div id="container"><xsl:attribute name="style">width:<xsl:value-of select="/picture/@width"/>px;</xsl:attribute>
			<table width="300" cellpadding="0" cellspacing="5" border="0">
				<tr>
					<td class="title">Mexico Coast</td>
...
<div id="copynav">copyright 2006 <a href="https://pbcoding.com/onfocus/contact.asp">Paul Bausch</a>  +  <a href="http://www.onfocus.com">refocus</a></div>
