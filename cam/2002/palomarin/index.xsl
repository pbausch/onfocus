...
<html>
<head>
	<title>onfocus.com : palomarin trail</title>
...
<body bgcolor="#000000" topmargin="0" leftmargin="0" text="#ffffff" alink="gray" link="#999999" vlink="#666666">
	...
	<tr>
		<td align="center" valign="center">
			<table cellpadding="5" cellspacing="0" border="0"><xsl:attribute name="width"><xsl:value-of select="/picture/@width"/></xsl:attribute>
				<tr>
					<td align="left">
						<font face="arial"><b>Palomarin Coastal Trail, Pt. Reyes</b></font>
					</td>
					<td align="right">
				...
				<tr>
					<td colspan="2" align="right">
						<font face="arial" size="1">
							copyright 2002 by <a href="https://pbcoding.com/onfocus/contact.asp">pb</a> | <a href="http://www.onfocus.com">refocus</a>
						</font>
					</td>
				</tr>
			</table>
