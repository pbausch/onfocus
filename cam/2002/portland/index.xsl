...
<html>
<head>
	<title>onfocus.com : walking tour of portland</title>
	...
	<tr>
		<td align="center" valign="center">
			<table width="300" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td align="left"><img src="WALKING_PORTLAND.gif" width="267" height="30" alt="Walking Portland" border="0"/><xsl:if test="picture/meta/sound"></xsl:if></td>
