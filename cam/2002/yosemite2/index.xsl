...
<html>
<head>
	<title>onfocus.com : hiking in yosemite</title>
	...
	<tr>
		<td align="center" valign="center">
			<table width="300" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td align="left"><img src="hiking_yosemite.gif" width="266" height="30" alt="Hiking In Yosemite" border="0"/><xsl:if test="picture/meta/sound"></xsl:if></td>
