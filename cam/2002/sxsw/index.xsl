		...
		<td align="center" valign="center">
			<table width="300" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<td align="right" valign="bottom"><nobr><font face="garamond" color="#333333" size="3"><b><xsl:value-of select="picture/@id"/> of <xsl:value-of select="picture/@total"/></b></font></nobr></td>
				</tr>
				<tr>
					<td  colspan="2" align="center" valign="center" bgcolor="#333333"><xsl:apply-templates select="picture/file"/></td>
				</tr>
				<tr>
					<td align="left" valign="middle"><div style="margin-left:5px;"><font face="arial" color="#666666" size="2"><xsl:apply-templates select="picture/meta/caption"/></font></div></td>
					<td align="right"><img src="sxswpics_2002.gif" width="101" height="37" alt="2002"/></td>
				</tr>
				<tr>
					<td align="left">
						<font size="2">
							<xsl:eval>GetBack(me,"&lt;img border=0 src=back.gif&gt;")</xsl:eval>
						</font>
					</td>
					<td align="right">
						<font size="2">
							<xsl:eval>GetNext(me,"&lt;img border=0 src=next.gif&gt;")</xsl:eval>
						</font>
					</td>
				</tr>
				...
				<tr>
					<td colspan="2" align="right">
						<br/><br/>
						<img src="copyright.gif" alt="copyright 2002 pb" width="100" height="6"/> <font size="1">|</font> <a href="index.asp"><img src="refocus.gif" border="0" alt="refocus" width="42" height="6"/></a>
					</td>
				</tr>
			</table>
		</td>
