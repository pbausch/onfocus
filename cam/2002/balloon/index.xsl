...
<html>
<head>
	<title>onfocus.com : hot air balloons</title>
	...
	<tr>
		<td align="center" valign="center">
			<table width="300" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td align="left"><div class="title">Hot Air Balloons</div><xsl:if test="picture/meta/sound"></xsl:if></td>
					<td align="right" valign="bottom"><div class="number"><xsl:value-of select="picture/@id"/> of <xsl:value-of select="picture/@total"/></div></td>
				</tr>
				<tr>
