...
<html>
<head>
	<title>onfocus.com : zion - july 2001</title>
	...
	<tr>
		<td align="center" valign="center">
			<table width="300" cellpadding="5" cellspacing="0" border="0">
				<tr>
					<td align="left">
						<font size="2"><b>The Narrows - Zion National Park</b></font>
					</td>
					<td align="right">
						<nobr><font face="arial" color="#999999" size="2"><b><xsl:value-of select="picture/@id"/> of <xsl:value-of select="picture/@total"/></b></font></nobr>
					</td>
				</tr>
				<tr>
					<td  colspan="2" align="center" valign="center" bgcolor="#333333">
						<xsl:apply-templates select="picture/file"/><br/><font face="arial" size="2"><xsl:apply-templates select="picture/meta/caption"/></font>
					</td>
				</tr>
				<tr>
					<td align="left">
						<font size="2">
							<xsl:eval>GetBack(me,"&lt;img border=0 src=http://www.onfocus.com/cam/yosemite/hike_back.gif&gt;")</xsl:eval>
						</font>
					</td>
					<td align="right">
						<font size="2">
							<xsl:eval>GetNext(me,"&lt;img border=0 src=http://www.onfocus.com/cam/yosemite/hike_next.gif&gt;")</xsl:eval>
						</font>
					</td>
				</tr>
