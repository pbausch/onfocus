...
<style type="text/css"> <![CDATA[          
	...
	textarea  {
	 ...
	 #copynav {
		...
		margin: 0 auto;
		margin-top:25px;
		border-bottom:solid #9BA56F 1px;
		border-right:solid #9BA56F 1px;
		text-align:center;
      }
	 -->
]]></style>
...
function checkForm(f) {
	...
	<title>onfocus.com | Oahu, Hawaii</title>
</head>

<body bgcolor="#FFFFFF" text="#999999" alink="#9BA56F" link="#9BA56F" vlink="#9BA56F">
<div id="container"><xsl:attribute name="style">width:<xsl:value-of select="/picture/@width"/>px;</xsl:attribute>
			<table width="300" cellpadding="0" cellspacing="5" border="0">
				<tr>
					<td class="title"><img style="margin-left:2px;" src="hawaii_title.gif" width="234" height="36" alt="" /></td>
...
<xsl:template match="picture/file">
		<img>
			...
			<xsl:attribute name="style">border:solid 1px #9BA56F;background-color:#aaa;</xsl:attribute>
		</img>
</xsl:template>
