...
<html>
<head>
	<title>onfocus.com : Oregon Coast 1937</title>
	...
	<tr>
		<td align="center" valign="center">
			<table width="300" cellpadding="0" cellspacing="5" border="0">
				<tr>
					<td class="title">Oregon Coast 1937</td>
					...
					<td colspan="2" align="center">
						<table width="100%" cellspacing="0" cellpadding="0" border="0">
							<tr>
								...
								<td align="center"><div class="caption">Detail from <i><xsl:apply-templates select="picture/meta/caption"/></i> (click for source photo)</div></td>
				...
				<tr>
					<td colspan="2" align="center" class="nav">
						<br/><br/>
						copyright 2004 pb | <a href="http://www.onfocus.com">refocus</a>
					</td>
				</tr>
			</table>
		</td>
...
<xsl:template match="picture/file">
		<a>
		<xsl:attribute name="href">../1937/index.asp?p=<xsl:value-of select="//picture/@id"/></xsl:attribute>
		<img>
			...
			<xsl:attribute name="alt"><xsl:value-of select="/picture/meta/caption"/> (click for source photo)</xsl:attribute>
			<xsl:attribute name="style">border:solid 5px white;</xsl:attribute>
		</img></a></xsl:template>
