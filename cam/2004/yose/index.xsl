...
<html>
<head>
	<title>onfocus.com : Yosemite</title>
					...
					<td colspan="2" align="center">
						<table width="100%" cellspacing="0" cellpadding="0" border="0">
							<tr>
								...
								<td align="center"><div class="caption"><xsl:value-of select="picture/file/name"/></div></td>
...
<xsl:template match="picture/meta">
		<em><xsl:value-of select="picture/file/name"/></em> <xsl:value-of select="picture/meta/caption"/>
</xsl:template>
