					...
					<td colspan="2" align="center">
						<table width="100%" cellspacing="0" cellpadding="0" border="0">
							<tr>
								...
								<td align="center"><div class="caption"><xsl:apply-templates select="picture/meta/caption"/> (click for more detail)</div></td>
...
<xsl:template match="picture/file">
		<a>
		<xsl:attribute name="href">../1937_detail/index.asp?p=<xsl:value-of select="//picture/@id"/></xsl:attribute>
		<img>
			...
			<xsl:attribute name="alt"><xsl:value-of select="/picture/meta/caption"/> (click for more detail)</xsl:attribute>
