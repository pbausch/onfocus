...
<style> <![CDATA[          
	 <!--
	 BODY {
		background:url(http://www.onfocus.com/cam/2004/radio-dials/radio-bkg3.gif) #ddd;
	}
	 textarea  {
	...
	<tr>
		<td align="center" valign="center">
			<table width="300" cellpadding="0" cellspacing="5" border="0">
				<tr>
					<td class="title"><img style="margin-left:2px;" src="radio-title.gif" width="231" height="27" alt="" /></td>
				...
				<tr>
					<td colspan="2" align="center">
						<table width="100%" cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td align="left" valign="top"><xsl:eval>GetBack(me,"&lt;img border=0 src=leftarrow_on.gif&gt;")</xsl:eval></td>
								<td align="center"><div class="caption"><xsl:apply-templates select="picture/meta/caption"/></div></td>
								<td align="right" valign="top"><xsl:eval>GetNext(me,"&lt;img border=0 src=rightarrow_on.gif&gt;")</xsl:eval></td>
							</tr>
						</table>
					</td>
				</tr>
			...
			<div class="copynav">copyright 2004 <a href="https://pbcoding.com/onfocus/contact.asp">Paul Bausch</a>  &#8226;  <a href="http://www.onfocus.com">refocus</a></div>
		</td>
	</tr>
</table>
...
<xsl:template match="picture/file">
		<img>
			...
			<xsl:attribute name="style">border:solid 1px #aaa;background-color:#aaa;</xsl:attribute>
		</img>
</xsl:template>
